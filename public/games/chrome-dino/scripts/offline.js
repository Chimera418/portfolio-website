...
Runner.prototype = {
  ...
  setupDisabledRunner() {
    ...
    document.addEventListener(Runner.events.KEYDOWN, function(e) {
      if (Runner.keycodes.JUMP[e.keyCode]) {
        ...
        var offlineIcon = document.querySelector('.icon');
        if (offlineIcon) offlineIcon.classList.add('icon-disabled');
      }
    }.bind(this));
  },
  ...
  loadSounds() {
    if (!IS_IOS) {
      ...
      for (const sound in Runner.sounds) {
        let soundEl = resourceTemplate.getElementById(Runner.sounds[sound]);
  ...
  init() {
    ...
    var iconNode = document.querySelector('.' + Runner.classes.ICON);
    if (iconNode) iconNode.style.visibility = 'hidden';
    ...
    this.outerContainerEl.appendChild(this.containerEl);
    // this.outerContainerEl.appendChild(this.slowSpeedCheckboxLabel); // REMOVED: Start Slower Option
