...
export const GET: APIRoute = async ({ request, url, clientAddress }) => {
  ...
  try {
    ...
    const existingInitials = await redis.hget<string>('arcade_registry', `ip:${deviceId}`);
...
export const POST: APIRoute = async ({ request, clientAddress }) => {
  try {
    ...
    let existingInitials = await redis.hget<string>('arcade_registry', `ip:${deviceId}`);
