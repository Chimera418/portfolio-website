...
export const GET: APIRoute = async ({ request, url, clientAddress }) => {
  ...
  try {
    ...
    const deviceId = queryDeviceId || request.headers.get('x-device-id') || request.headers.get('x-forwarded-for') || request.headers.get('x-real-ip') || clientAddress || 'unknown';
...
export const POST: APIRoute = async ({ request, clientAddress }) => {
  try {
    ...
    const { game, player, score, deviceId: bodyDeviceId } = body;
    ...
    const deviceId = bodyDeviceId || request.headers.get('x-device-id') || request.headers.get('x-forwarded-for') || clientAddress || 'unknown';
